...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = {
    {KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, XXXXX, KC_GRV, KC_6, KC_7, KC_8, KC_9, KC_0, G(KC_BSPC), KC_BSPC},
  ...
  [LAYER_L1] = {
    ...
    {KC_CAPS, OS_SHFT, OS_CTRL, OS_ALT, OS_CMD, XXXXX, TAB_L, TAB_R, KC_GRV, OS_CMD, OS_ALT, OS_CTRL, OS_SHFT, XXXXX, KC_TRNS},
  ...
  [LAYER_L2] = {
    {C(A(KC_DEL)), KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, XXXXX,XXXXX, KC_6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12},
    {KC_TAB,  XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, KC_MUTE, XXXXX, XXXXX, XXXXX, KC_UP, XXXXX, XXXXX, XXXXX, XXXXX},
    {KC_CAPS, OS_SHFT, OS_CTRL, OS_ALT, OS_CMD,  XXXXX, KC_VOLD, KC_VOLU,   XXXXX, OS_CMD, OS_ALT, OS_CTRL, OS_SHFT, XXXXX, XXXXX},
    {_______, MSPL, MSPR,  XXXXX, XXXXX, XXXXX, KC_F14, KC_F15, XXXXX,   XXXXX, G(KC_DOWN), XXXXX, TAB_L, KC_PGUP, TAB_R},
    {_______, _______, _______, _______, _______,_______, XXXXX, XXXXX,XXXXX, _______, _______, _______, KC_HOME, KC_PGDN, KC_END},
  },

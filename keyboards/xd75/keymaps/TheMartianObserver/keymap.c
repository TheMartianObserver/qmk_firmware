...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = {
    ...
    {G(KC_SPC), KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, LT(LAYER_NAV, KC_SPC), KC_LSFT, LT(LAYER_NUM, KC_BSPC), LT(LAYER_SYM, KC_SPC), KC_RSFT, KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT},
  },

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = {
    ...
    {KC_TILDE, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_UNDS, KC_PLUS, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_BSLS, KC_UP},
  ...
  [LAYER_BASEB] = {
    ...
    {LCTL_T(KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_MINUS, KC_EQL, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT},
    {KC_GRV, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_UNDS, KC_PLUS, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_BSLS, KC_UP},
    {OS_SHFT, OS_CTRL, OS_ALT, OS_CMD, KC_SPC, LT(LAYER_NAV, KC_SPC), G(KC_SPC), KC_BSPC, LT(LAYER_SYM, KC_SPC), KC_SPC, KC_LGUI, KC_LALT, KC_LEFT, KC_DOWN, KC_RGHT},
  },
  ...
  [LAYER_BASEA] = {
    ...
    {KC_TILDE, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_UNDS, KC_PLUS, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_BSLS, KC_UP},
    {OS_SHFT, OS_CTRL, OS_ALT, OS_CMD, LA_NAV, LT(LAYER_NAV, KC_SPC), G(KC_SPC), KC_BSPC, LT(LAYER_SYM, KC_SPC), LA_SYM, KC_LGUI, KC_LALT, KC_LEFT, KC_DOWN, KC_RGHT},
  },
  ...
  [LAYER_SYM] = {
    ...
    {XXXX, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, XXXX, XXXX, KC_CIRC, KC_AMPR, KC_ASTR, XXXX, KC_TILDE, ____, XXXX},
  ...
  [LAYER_NAV] = {
    ...
    {XXXX, MSPL, MSPR, KC_MPRV, KC_MPLY, KC_MNXT, KC_F14, KC_F15, XXXX, KC_HOME, SW_APP, KC_END, KC_DEL, ____, XXXX},
    {____, ____, ____, ____, ____,____, ____, ____, ____, ____, ____, ____, ____, ____, ____},
  },

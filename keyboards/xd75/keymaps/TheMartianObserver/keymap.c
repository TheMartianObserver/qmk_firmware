...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_SYM] = {
    ...
    {____, KC_ESC, KC_LBRC, KC_LCBR, KC_LPRN, KC_GRV, XXXX, XXXX, KC_TILDE, KC_RPRN, KC_RCBR, KC_RBRC, KC_GRV, XXXX, XXXX},
    {XXXX, KC_MINS, KC_UNDS, KC_EQL, KC_PLUS, KC_BSLS, XXXX, XXXX, KC_PIPE, OS_CMD, OS_ALT, OS_CTRL, OS_SHFT, XXXX, XXXX},
    {XXXX, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, XXXX, XXXX, KC_CIRC, KC_AMPR, KC_ASTR, XXXX, XXXX, XXXX, XXXX},
  ...
  [LAYER_NAV] = {
    ...
    {XXXX, KC_TAB, SW_WIN, TAB_L, TAB_R, KC_VOLU, KC_MUTE, XXXX, XXXX, KC_PGUP, KC_UP, KC_PGDN, KC_BSPC, XXXX, XXXX},
    {KC_CAPS, OS_SHFT, OS_CTRL, OS_ALT, OS_CMD, KC_VOLD, XXXX, XXXX, KC_CAPS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENT, XXXX, XXXX},

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_NAV] = {
    ...
    {KC_TAB, S(KC_TAB), SW_WIN, TAB_L, TAB_R, XXXX, KC_MUTE, XXXX, KC_DEL, KC_PGUP, XXXX, KC_PGDN, KC_BSPC, XXXX, XXXX},
    {KC_CAPS, OS_SHFT, OS_CTRL, OS_ALT, OS_CMD, XXXX, KC_VOLD, KC_VOLU, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_ENT, XXXX, XXXX},

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = {
    ...
    {KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, LSFT_T(KC_BSPC), LT(LAYER_NAV, KC_SPC), KC_DEL, KC_BSPC, LT(LAYER_SYM, KC_SPC), LSFT_T(KC_BSPC), KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT},
  },

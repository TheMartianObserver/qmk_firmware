...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = {
    ...
    {G(KC_SPC), KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, LT(LAYER_NAV, KC_SPC), LSFT_T(KC_DEL), LT(LAYER_NUM, KC_BSPC), LT(LAYER_SYM, KC_SPC), KC_RSFT, KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT},
  },
  ...
  [LAYER_NAV] = {
    ...
    {KC_TAB, S(KC_TAB), SW_WIN, TAB_L, TAB_R, S(KC_TAB), KC_MUTE, XXXX, KC_DEL, KC_PGUP, KC_UP, KC_PGDN, KC_BSPC, XXXX, XXXX},
    {KC_CAPS, OS_SHFT, OS_CTRL, OS_ALT, OS_CMD, KC_TAB, KC_VOLD, KC_VOLU, XXXX, KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENT, XXXX, XXXX},

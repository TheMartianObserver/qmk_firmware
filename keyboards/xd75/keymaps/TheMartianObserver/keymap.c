...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_L1] = {
    ...
    {KC_TAB, KC_PLUS, KC_UNDS, KC_EQL, KC_MINUS, KC_LCBR, XXXXX, XXXXX, KC_RCBR, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, KC_BSLS, XXXXX},
    {KC_CAPS, OS_CTRL, OS_ALT, OS_CMD, OS_SHFT, XXXXX, TAB_L, TAB_R, KC_GRV, OS_SHFT, OS_CMD, OS_ALT, OS_CTRL, KC_TILDE, KC_TRNS},
  ...
  [LAYER_L2] = {
    ...
    {KC_CAPS, OS_CTRL, OS_ALT, OS_CMD, OS_SHFT, XXXXX, KC_VOLD, KC_VOLU,   XXXXX, KC_LEFT, KC_DOWN, KC_RIGHT, OS_SHFT, XXXXX, XXXXX},
  ...
  [LAYER_L4] = {
    {XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX},
    {XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX},
    {XXXXX, OS_CTRL, OS_ALT, OS_CMD, OS_SHFT, XXXXX, XXXXX, XXXXX, XXXXX, KC_MINUS, KC_EQL, XXXXX, _____, XXXXX, XXXXX},
    {XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, KC_UNDS, KC_PLUS, XXXXX, XXXXX, XXXXX, XXXXX},
    {XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX},
  },
};

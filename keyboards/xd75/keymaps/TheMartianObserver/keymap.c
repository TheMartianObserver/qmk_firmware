...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = {
    ...
    {G(KC_SPC), KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, LT(LAYER_NAV, KC_SPC), LSFT_T(KC_DEL), MO(LAYER_NUM), LT(LAYER_SYM, KC_SPC), RSFT_T(KC_BSPC), KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT},
  },
  ...
  [LAYER_SYM] = {
    ...
    {KC_BSPC, KC_MINS, KC_UNDS, KC_EQL, KC_PLUS, KC_PIPE, XXXX, XXXX, KC_BSLS, OS_CMD, OS_ALT, OS_CTRL, OS_SHFT, XXXX, XXXX},
    {KC_GRV, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, XXXX, XXXX, KC_CIRC, KC_AMPR, KC_ASTR, XXXX, XXXX, ____, ____},
    {____, ____, ____, ____, KC_BSPC, MO(LAYER_NUM), ____, ____, ____, ____, ____, ____, ____, ____, ____},
  },

  [LAYER_NAV] = {
    {XXXX, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, XXXX,XXXX, KC_6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12},
    {KC_TAB, S(KC_TAB), SW_WIN, TAB_L, TAB_R, S(KC_TAB), KC_MUTE, XXXX, XXXX, KC_PGUP, KC_UP, KC_PGDN, XXXX, XXXX, XXXX},
    {KC_CAPS, OS_SHFT, OS_CTRL, OS_ALT, OS_CMD, KC_TAB, KC_VOLD, KC_VOLU, XXXX, KC_LEFT, KC_DOWN, KC_RIGHT, KC_BSPC, KC_ENT, XXXX},
    {KC_GRV, MSPL, MSPR, KC_MPRV, KC_MPLY, KC_MNXT, KC_F14, KC_F15, XXXX, KC_HOME, XXXX, KC_END, KC_DEL, ____, ____},
    {____, ____, ____, ____, ____,____, ____, ____, MO(LAYER_NUM), KC_BSPC, ____, ____, ____, ____, ____},
  },

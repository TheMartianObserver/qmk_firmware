...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = {
    ...
    {G(KC_SPC), OS_SHFT, OS_CTRL, OS_ALT, OS_CMD, LT(LAYER_NAV, KC_SPC), KC_LSFT, LT(LAYER_NUM, KC_BSPC), LT(LAYER_SYM, KC_SPC), OS_SHFT, OS_CMD, OS_ALT, KC_LEFT, KC_DOWN, KC_RGHT},
  },

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = {
    ...
    {OS_SHFT, OS_CTRL, OS_ALT, OS_CMD, LA_NAV, LSFT_T(KC_SPC), XXXX, KC_BSPC, KC_SPC, LA_SYM, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT},
  },


  [LAYER_SYM] = {
    {C(A(KC_DEL)), XXXX, XXXX, XXXX, XXXX, XXXX, XXXX, XXXX, XXXX, XXXX,   XXXX, XXXX, XXXX, XXXX, XXXX},
    {XXXX, KC_ESC, KC_LBRC, KC_LCBR, KC_LPRN, KC_TILDE, XXXX, XXXX, KC_CIRC, KC_RPRN, KC_RCBR, KC_RBRC, KC_GRV, XXXX, XXXX},
  ...
  [LAYER_NAV] = {
    ...
    {KC_TAB,  KC_TAB, XXXX, TAB_L, TAB_R, KC_VOLU, KC_MUTE, XXXX, XXXX, KC_PGUP, KC_UP, KC_PGDN, KC_DEL, XXXX, XXXX},
    {KC_CAPS, OS_SHFT, OS_CTRL, OS_ALT, OS_CMD, KC_VOLD, XXXX, XXXX, KC_CAPS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_BSPC, XXXX, XXXX},
    {XXXX, MSPL, MSPR,  XXXX, XXXX, XXXX, KC_F14, KC_F15, XXXX, KC_HOME, XXXX, KC_END, KC_ENT, XXXX, XXXX},

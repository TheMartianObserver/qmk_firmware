...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = {
    {KC_ESC, K1, K2, K3, K4, K5, KC_LCBR, KC_RCBR, KC_6, KC_7, KC_8, KC_9, KC_0, G(KC_BSPC), KC_BSPC},
    ...
    {KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, LSFT_T(KC_BSPC), LT(LAYER_NAV, KC_SPC), KC_DEL, KC_BSPC, LT(LAYER_SYM, KC_SPC), LT(LAYER_SYM, KC_BSPC), KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT},
  },
  ...
  [LAYER_SYM] = {
    ...
    {KC_SPC, KC_EQL, KC_PLUS, KC_UNDS, KC_MINS, KC_PIPE, XXXX, XXXX, KC_BSLS, OS_SHFT, OS_CMD, OS_ALT, OS_CTRL, XXXX, XXXX},
  ...
  [LAYER_NAV] = {
    {XXXX, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, XXXX,XXXX, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12},
  ...
  [LAYER_NUM] = {
    ...
    {KC_UNDS, OS_CTRL, OS_ALT, OS_CMD, OS_SHFT, XXXX, XXXX, XXXX, KC_DOT, OS_CMD, OS_ALT, OS_CTRL, OS_SHFT, XXXX, XXXX},

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_SYM] = {
    ...
    {XXXX, KC_MINS, KC_UNDS, KC_EQL, KC_PLUS, KC_BSLS, XXXX, XXXX, KC_PIPE, OS_SHFT, OS_CMD, OS_ALT, OS_CTRL, XXXX, XXXX},
  ...
  [LAYER_SETTINGS] = {
    ...
    {XXXX, XXXX, XXXX, XXXX, XXXX,  XXXX, XXXX, XXXX,   XXXX,   XXXX, XXXX, XXXX, XXXX, XXXX, XXXX},
    {DF(LAYER_BASEA), DF(LAYER_BASE), XXXX, XXXX, XXXX,XXXX, XXXX,   XXXX,XXXX, XXXX, XXXX, XXXX, XXXX, XXXX, XXXX},
  },
